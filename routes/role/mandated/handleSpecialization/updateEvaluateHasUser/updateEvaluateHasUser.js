...
const updateEvaluateHasUser = async (req, res) => {
  ...
  const {
    typeEvaluateID, evaluateHasUser1ID, evaluateHasUser2ID, evaluateHasUser3ID, academic1_userID, academic2_userID, academic3_userID, specializationHasSemesterID,
  } = req.body;
  ...
  if (typeEvaluateID == 1) {
    ...
    dataArray = [
      {
        evaluateHasUserID: evaluateHasUser1ID, userID: academic1_userID, academicCategory: 4, specializationHasSemesterID,
      },
      {
        evaluateHasUserID: evaluateHasUser2ID, userID: academic2_userID, academicCategory: 5, specializationHasSemesterID,
      },
    ];
  }
  try {
