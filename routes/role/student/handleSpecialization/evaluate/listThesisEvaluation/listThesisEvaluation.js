...
const listThesisEvaluation = async (req, res) => {
  ...
  try {
    const data = await selectSpecializationHasStudentInstance.selectSpecializationHasStudent(dataBase, 'thesisEvaluation', userID, specializationHasUserID, specializationHasSemesterID);
